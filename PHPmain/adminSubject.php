...
<head>
    ...
    <link rel="stylesheet" href="../CSS/Admin/adminSubject.css"> <!-- Link to custom CSS -->
</head>
...
<body>
    <div class="container mt-5">
        ...
        <div class="d-flex justify-content-center">
            <div class="card w-75"> <!-- Center the card and limit its width -->
    ...
    <div class="modal fade" id="addSubject" tabindex="-1" aria-labelledby="addSubjectLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="addSubjectLabel">Create New Subject</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form action="../PHP/adminSubjectAdd.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input type="text" id="adminSubjectName" name="adminSubjectName" class="form-control" placeholder="Science" required>
                        </div>
                        <div class="mb-3">
                            <label for="adminSubjectPicture" class="form-label">Subject Picture</label>
                            <input type="file" id="adminSubjectPicture" name="adminSubjectPicture" class="form-control" required>
                        </div>
                    </div>
                    <div class="modal-footer">
