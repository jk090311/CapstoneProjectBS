...
if(isset($_POST['stFullName'])) { // Changed from 'subjectTeacherFullName' to match form field name
    ...
    $stGradelvl = mysqli_real_escape_string($connection, $_POST['stGradelvl']); // New field
    $stSection = mysqli_real_escape_string($connection, $_POST['stSection']); // New field  
    ...
    $stmt->bind_param("sssssis", $stFullName, $stContactNumber, $stEmail, $stHashedPassword, $stGradelvl , $stSection, $stSubject, $secondarySub, $originalstName);
