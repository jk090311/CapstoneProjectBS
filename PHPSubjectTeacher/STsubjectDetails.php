...
<head>
    ...
    <link rel="stylesheet" href="../CSS/SubjectTeacher/stSubjectDetails.css">
        ...
        <div class="panel">
            <div class="card">
                <div class="tabs" style="margin-bottom:18px;">
                    <button id="tabSubjectsBtn" class="active">Student Names</button>
                ...
                <div id="tab-subjects" class="tab-content" style="display:block; width:100%;">
                    <div id="subjects-list" class="subject-container">
                        ...
                        if (!$result) {
                            echo "<div style='color:#b00; padding:12px;'>Failed to load subjects: " . htmlspecialchars(mysqli_error($conn)) . "</div>";
                        } else {
                ...
                <div id="tab-students" class="tab-content" style="display:none; width:100%;">
                    <div id="student-panel" class="card">
                        ...
                        <div style="display:flex; gap:8px; margin-bottom:12px; align-items:center;">
                            <input id="studentSearchMain" type="text" placeholder="Enter student ID (numeric)..."
                                style="flex:1; padding:10px 12px; border-radius:8px; border:1px solid #d7e3e5;">
                            <button id="searchStudentBtn"
                                style="padding:10px 12px; border-radius:8px; border:1px solid #0f7a8a; background:#0f7a8a; color:#fff; cursor:pointer;">Search</button>
                        </div>
