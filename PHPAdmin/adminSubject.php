                            ...
                            <tbody>
                                ...
                                while ($row = mysqli_fetch_assoc($result)) {
                                    echo "<tr>
                                        ...
                                        <td><img src='../Uploads/{$row['subject_picture']}' width='50' height='50' alt='{$row['subject_name']}'></td>
                                        <td>
                                            <!-- Edit Button -->
                                            ...
                                            <!-- Delete Button -->
                                            <form action='../PHP/adminSubjectDelete.php' method='POST' style='display:inline;' onsubmit='return confirmDelete()'>
